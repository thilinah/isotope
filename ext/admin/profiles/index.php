...
?><div class="span9">
	...
	<ul class="nav nav-tabs" id="modTab" style="margin-bottom:0px;margin-left:5px;border-bottom: none;">
		<li class="active"><a id="tabProfile" href="#tabPageProfile">Profiles</a></li>
	</ul>
	 
	<div class="tab-content">
		<div class="tab-pane active" id="tabPageProfile">
			<div id="Profile" class="reviewBlock" data-content="List" style="padding-left:5px;">
...
modJsList['tabProfile'].setRemoteTable(true);
